...
class LocationDataServiceTest {
    ...
    void savesKnownLocationFields() {
        ...
        ArgumentCaptor<LocationRecord> captor = ArgumentCaptor.forClass(LocationRecord.class);
        verify(repository).save(captor.capture());
        LocationRecord record = captor.getValue();

        assertThat(record.getLatitude()).isEqualByComparingTo(new BigDecimal("22.570720"));
