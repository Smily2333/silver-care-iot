...
> **Superseded:** The current Web client uses an interactive login and never embeds admin credentials in
> the build. The map now uses Leaflet. See `docs/deployment.md` before applying any historical steps below.
